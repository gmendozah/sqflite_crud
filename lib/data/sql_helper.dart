...
import 'package:sqflite_crud/models/note.dart';
...
class SqlHelper {
  ...
  FutureOr<void> _createDb(Database db, int version) async {
    String query =
        'CREATE TABLE $tableNotes ($colId INTEGER PRIMARY KEY, $colName TEXT,'
        ' $colDate TEXT, $colNotes TEXT, $colPosition INTEGER)';
  ...
  Future<List<Note>> getNotes() async {
    ...
    List<Note> notes = List<Note>.from(notesList.map((e) => Note.fromMap(e)));
    return notes;
  }
